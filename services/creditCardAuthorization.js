...
const {xmlBody} = require('../xmlRequest/creditCardAuthorization');
...
async function callCreditCardAuthorization() {
    ...
    try {
        ...
        console.error('Error calling credit card authorization:', error.message);
    }
}

module.exports = callCreditCardAuthorization;