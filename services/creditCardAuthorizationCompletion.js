...
const {xmlBody} = require('../xmlRequest/creditCardAuthorizationCompletion')
...
async function callCreditCardAuthorizationCompletion() {
    ...
    try {
        ...
        console.error('Error calling credit card authorization completion:', error.message)
    }
}

module.exports = callCreditCardAuthorizationCompletion